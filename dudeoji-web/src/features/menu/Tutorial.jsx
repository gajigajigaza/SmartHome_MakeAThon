...
export const TUTORIAL_STEPS = [
  {
    ...
    description:
      "왼쪽 위 새싹 아이콘을 누르면 마이페이지, 센서 측정값, 로그아웃 메뉴를 열 수 있어요.",
  ...
  },
  {
    key: "profile",
    badge: "아이콘",
    title: "더 알아보고 싶다면, 아이콘을 하나씩 해금해 보세요",
    description:
      "추천을 수락/거절해보거나, 창문·에어컨을 직접 조작하거나, 전력을 절감할 때마다 새 아이콘이 열려요. 잠긴 아이콘에 커서를 올리거나 눌러보면 어떻게 얻는지 알려줘요.",
